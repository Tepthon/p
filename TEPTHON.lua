...
Status = 'المطور'
elseif DevelopersQ then
Status = Redis:get(TheTEPTHON.."TEPTHON:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
...
return {
Lock     = '[. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ](https://t.me/Tepthon)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ](https://t.me/Tepthon)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ](https://t.me/Tepthon)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ](https://t.me/Tepthon)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ](https://t.me/Tepthon)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ](https://t.me/Tepthon)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(TheTEPTHON.."Lock:channell"..msg_chat_id) then
print(Redis:get(TheTEPTHON.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(TheTEPTHON.."chadmin"..msg_chat_id) then
...
if text and Redis:get(TheTEPTHON..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TheTEPTHON..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
Redis:incr(TheTEPTHON.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheTEPTHON.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheTEPTHON.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(TheTEPTHON) then
local N = (Redis:get(TheTEPTHON.."Name:Bot") or "الروكس")
photo = LuaTele.getUserProfilePhotos(TheTEPTHON)
...
Redis:set(TheTEPTHON.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TheTEPTHON.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(TheTEPTHON..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
...
{
{text = '. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ', url='https://t.me/Tepthon'},
},
}
}
...
if Redis:get(TheTEPTHON.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TheTEPTHON.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TheTEPTHON.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTEPTHON.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(TheTEPTHON.."mshaher"..msg.chat_id) then
if text == Redis:get(TheTEPTHON.."mshaher"..msg.chat_id) then
Redis:del(TheTEPTHON.."mshaher"..msg.chat_id)
Redis:incrby(TheTEPTHON.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(TheTEPTHON.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(TheTEPTHON.."Game:enkliz"..msg.chat_id) then
Redis:incrby(TheTEPTHON.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTEPTHON.."Game:enkliz"..msg.chat_id)
...
Redis:set(TheTEPTHON..'TEPTHON:Channel:Join:Name',UserId_Info.title) 
...
--download('https://github.com/Mohmmedrg/NIGHTMARE/blob/main/TEPTHON.lua','TEPTHON.lua')
...
local photo = LuaTele.getUserProfilePhotos(TheTEPTHON)
local UserInfo = LuaTele.getUser(TheTEPTHON)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(TheTEPTHON.."TEPTHON:Name:Bot") or "الروكس")
Groups = (Redis:scard(TheTEPTHON..'TEPTHON:ChekBotAdd') or 0)
Users = (Redis:scard(TheTEPTHON..'TEPTHON:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 'https://t.me/P17_12'}, 
},
{
{text = Grosupsw, url = 'https://t.me/Tepthon'}, 
},
{
{text = Usperos, url = 'https://t.me/Tepthon'}, 
},
}
...
local NumAdd = Redis:get(TheTEPTHON.."TEPTHON:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TheTEPTHON.."TEPTHON:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if UserInfo.first_name ~= "" then
Redis:sadd(TheTEPTHON.."TEPTHON:TheBasicsQ:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(TheTEPTHON.."TEPTHON:TheBasicsQ:Group"..msg_chat_id,msg.sender.user_id) 
...
{
{text = ' ❲ ‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Tepthon . ❳ ',url="https://t.me/Tepthon"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس  Tepthonفقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
Redis:set(TheTEPTHON.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TheTEPTHON.."lockalllll"..msg_chat_id,"on")
...
if Redis:get(TheTEPTHON.."lockalllll"..msg_chat_id) == "on" then
if not msg.Addictive then
...
Redis:del(TheTEPTHON..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(TheTEPTHON..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheTEPTHON..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(TheTEPTHON..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheTEPTHON..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n‹ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheTEPTHON..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(TheTEPTHON..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheTEPTHON..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(TheTEPTHON..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheTEPTHON..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(TheTEPTHON..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheTEPTHON..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheTEPTHON..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(TheTEPTHON..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(TheTEPTHON..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(TheTEPTHON..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(TheTEPTHON.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(TheTEPTHON..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(TheTEPTHON.."idnotmembio"..msg.chat_id)
...
if Redis:get(TheTEPTHON..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheTEPTHON..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheTEPTHON..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheTEPTHON..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheTEPTHON..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheTEPTHON..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheTEPTHON..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheTEPTHON..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheTEPTHON..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheTEPTHON..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheTEPTHON..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheTEPTHON..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(TheTEPTHON.."AlNsb"..msg.chat_id) then    
Redis:set(TheTEPTHON..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheTEPTHON.."AlNsb"..msg.chat_id) then    
Redis:set(TheTEPTHON..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheTEPTHON.."AlNsb"..msg.chat_id) then    
Redis:set(TheTEPTHON..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheTEPTHON.."AlNsb"..msg.chat_id) then    
Redis:set(TheTEPTHON..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '‹ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheTEPTHON.."AlNsb"..msg.chat_id) then    
Redis:set(TheTEPTHON..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheTEPTHON.."AlNsb"..msg.chat_id) then    
Redis:set(TheTEPTHON..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(TheTEPTHON..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(TheTEPTHON.."AlNsb"..msg.chat_id,"true")
...
Redis:del(TheTEPTHON.."AlNsb"..msg.chat_id)
...
if Redis:get(TheTEPTHON..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(TheTEPTHON.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(TheTEPTHON..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(TheTEPTHON.."myphoto"..msg.chat_id)
...
Redis:del(TheTEPTHON.."mybuti"..msg_chat_id)
...
Redis:set(TheTEPTHON.."mybuti"..msg_chat_id,"off")
...
Redis:del(TheTEPTHON.."sayy"..msg_chat_id)
...
Redis:set(TheTEPTHON.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(TheTEPTHON.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(TheTEPTHON.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(TheTEPTHON.."myphoto"..msg_chat_id) == "off" then
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheTEPTHON..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
...
if not Redis:sismember(TheTEPTHON.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTEPTHON.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTEPTHON.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(TheTEPTHON.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(TheTEPTHON.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTEPTHON.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTEPTHON.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTEPTHON.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(TheTEPTHON.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTEPTHON.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTEPTHON.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTEPTHON.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTEPTHON.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheTEPTHON.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTEPTHON.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheTEPTHON.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:srem(TheTEPTHON.."TEPTHON:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TheTEPTHON.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheTEPTHON..'TEPTHON:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheTEPTHON..'TEPTHON:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n‹ : عمࢪي اشتࢪك ثم استخدم الامࢪ❗️*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(TheTEPTHON.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTEPTHON.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local Info_Members = Redis:smembers(TheTEPTHON.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTEPTHON.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local httpsCurl = "http://185.185.127.158/TEPTHON/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
if text == "غنيلي" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختياࢪ الاغنيه لك : -](t.me/Tepthon)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختياࢪ الشعر لك :  ](t.me/Tepthon)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ',url="t.me/Tepthon"}
},
{
...
if text == "ميمز" then
Abs = math.random(2,140); 
local Text =" [متحركات Gٍٓif ᯓ ](t.me/Tepthon)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . ',url="t.me/Tepthon"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/https://t.me/Tepthon/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local UserId_Info = LuaTele.searchPublicChat("1260465030")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝗎𝗉𝖽𝖺𝗍𝖾’s ❳', url = "https://t.me/Tepthon"}
},
{
{text = '- Tepthon  𝖲𝗈𝗎𝗋𝖼𝖾 .', url='https://t.me/Tepthon'},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.TEPTHONchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس  Tepthon',url="t.me/Tepthon"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(TheTEPTHON..msg_chat_id.."mutlqat:")
...
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/Tepthon'},{text = '. ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧', url = 'https://t.me/Tepthon'}, 
},
{
{text = 'مبࢪمج اݪسوࢪس', url = 't.me/P17_12'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/Tepthon&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(1260465030) then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت محمد مطور السورس يقلبي🌚💘","md",true)
...
{
{text = '❲ VIP version updates ❳', url = "https://https://t.me/lZZIlI"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
Redis:del(TheTEPTHON.."TEPTHON:Status:joinet"..msg_chat_id) 
...
Redis:set(TheTEPTHON.."TEPTHON:Status:joinet"..msg_chat_id,true) 
...
if text and Redis:get(TheTEPTHON.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(TheTEPTHON.."chadmin"..msg_chat_id,text) 
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حفظ ايدي القناه","md",true)  
Redis:del(TheTEPTHON.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheTEPTHON.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص『 '..Controller_Num(7)..' 』* ',"md",true)  
end
Redis:set(TheTEPTHON.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheTEPTHON..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(TheTEPTHON.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(TheTEPTHON.."Lock:channell"..msg_chat_id)  
...
Redis:set(TheTEPTHON.."TEPTHON:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(TheTEPTHON..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TheTEPTHON.."TEPTHON:Lock:phshar"..msg_chat_id)  
...
Redis:del(TheTEPTHON..'lock:Fars'..msg.chat_id) 
...
if text == (Redis:get(TheTEPTHON.."TEPTHON:Name:Bot") or "الروكس") then
local NamesBot = (Redis:get(TheTEPTHON.."TEPTHON:Name:Bot") or "الروكس")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/Tepthon'}, 
},
{
...
local BotName = {
"الحمد لله ونته",
"على قول @P17_12 ع الباري ونتَ",
"انا بخير",
}
return LuaTele.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md",true)   
end
if text == "بوسه" then
local NamesBot = (Redis:get(TheTEPTHON.."TEPTHON:Name:Bot") or "TEPTHON")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
"اختفوووو يلعار ابلع من عمك محمد??🏃‍♀️.",
...
local bank_users = Redis:smembers(TheTEPTHON.."zrfffidtf")
...
local mony = Redis:get(TheTEPTHON.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(TheTEPTHON..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(TheTEPTHON.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(TheTEPTHON.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheTEPTHON.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(TheTEPTHON.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheTEPTHON.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(TheTEPTHON..':toob:Name:'..zwga_id)
fnte = Redis:get(TheTEPTHON..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender.user_id) == tonumber(TheTEPTHON) then
return LuaTele.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(TheTEPTHON..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(TheTEPTHON..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(TheTEPTHON..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(TheTEPTHON..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(TheTEPTHON..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(TheTEPTHON..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(TheTEPTHON..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(TheTEPTHON.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(TheTEPTHON.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(TheTEPTHON.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheTEPTHON..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(TheTEPTHON..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(TheTEPTHON..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دولار ","md")
end
if Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheTEPTHON..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(TheTEPTHON..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(TheTEPTHON..':toob:Name:'..zoog2)
...
if Redis:sismember(TheTEPTHON.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(TheTEPTHON.."noolb"..yemsg.sender.user_id)
gg = Redis:get(TheTEPTHON.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(TheTEPTHON.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(TheTEPTHON.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(TheTEPTHON.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(TheTEPTHON.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(TheTEPTHON.."mznom"..msg_chat_id..zwga_id)
Redis:srem(TheTEPTHON.."almtzog"..msg_chat_id,zwga_id)
Redis:del(TheTEPTHON.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(TheTEPTHON.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(TheTEPTHON..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(TheTEPTHON..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(TheTEPTHON..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(TheTEPTHON..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(TheTEPTHON..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(TheTEPTHON..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(TheTEPTHON.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheTEPTHON.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
...
gg = "والت كارد ."
flossst = Redis:get(TheTEPTHON.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(TheTEPTHON.."nonna"..msg.sender.user_id,news)
Redis:set(TheTEPTHON.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TheTEPTHON.."nnonb"..msg.sender.user_id,text)
Redis:set(TheTEPTHON.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheTEPTHON.."nonallname"..creditcc,news)
Redis:set(TheTEPTHON.."nonallbalc"..creditcc,balas)
Redis:set(TheTEPTHON.."nonallcc"..creditcc,creditcc)
Redis:set(TheTEPTHON.."nonallban"..creditcc,text)
Redis:set(TheTEPTHON.."nonallid"..creditcc,banid)
Redis:sadd(TheTEPTHON.."noooybgy",msg.sender.user_id)
Redis:del(TheTEPTHON.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheTEPTHON.."nonna"..msg.sender.user_id,news)
Redis:set(TheTEPTHON.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TheTEPTHON.."nnonb"..msg.sender.user_id,text)
Redis:set(TheTEPTHON.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheTEPTHON.."nonallname"..creditvi,news)
Redis:set(TheTEPTHON.."nonallbalc"..creditvi,balas)
Redis:set(TheTEPTHON.."nonallcc"..creditvi,creditvi)
Redis:set(TheTEPTHON.."nonallban"..creditvi,text)
Redis:set(TheTEPTHON.."nonallid"..creditvi,banid)
Redis:sadd(TheTEPTHON.."noooybgy",msg.sender.user_id)
Redis:del(TheTEPTHON.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheTEPTHON.."nonna"..msg.sender.user_id,news)
Redis:set(TheTEPTHON.."noolb"..msg.sender.user_id,creditex)
Redis:set(TheTEPTHON.."nnonb"..msg.sender.user_id,text)
Redis:set(TheTEPTHON.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheTEPTHON.."nonallname"..creditex,news)
Redis:set(TheTEPTHON.."nonallbalc"..creditex,balas)
Redis:set(TheTEPTHON.."nonallcc"..creditex,creditex)
Redis:set(TheTEPTHON.."nonallban"..creditex,text)
Redis:set(TheTEPTHON.."nonallid"..creditex,banid)
Redis:sadd(TheTEPTHON.."noooybgy",msg.sender.user_id)
Redis:del(TheTEPTHON.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
Redis:srem(TheTEPTHON.."noooybgy", msg.sender.user_id)
Redis:del(TheTEPTHON.."noolb"..msg.sender.user_id)
Redis:del(TheTEPTHON.."zrffdcf"..msg.sender.user_id)
Redis:srem(TheTEPTHON.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(TheTEPTHON.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(TheTEPTHON.."nool:flotysb"..v)
Redis:del(TheTEPTHON.."zrffdcf"..v)
Redis:del(TheTEPTHON.."innoo"..v)
Redis:del(TheTEPTHON.."nnooooo"..v)
Redis:del(TheTEPTHON.."nnoooo"..v)
Redis:del(TheTEPTHON.."nnooo"..v)
Redis:del(TheTEPTHON.."nnoo"..v)
Redis:del(TheTEPTHON.."polic"..v)
Redis:del(TheTEPTHON.."ashmvm"..v)
Redis:del(TheTEPTHON.."hrame"..v)
Redis:del(TheTEPTHON.."test:mmtlkat6"..v)
Redis:del(TheTEPTHON.."zahbmm2"..v)
end
Redis:del(TheTEPTHON.."ttpppi")
...
Redis:del(TheTEPTHON.."zrfffidtf")
...
ballanceed = Redis:get(TheTEPTHON.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TheTEPTHON.."noolb"..msg.sender.user_id)
gg = Redis:get(TheTEPTHON.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheTEPTHON.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(TheTEPTHON.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(TheTEPTHON.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دولار 💸 )\n• الزرف ( "..pppp.." دولار ?? )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(TheTEPTHON.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(TheTEPTHON.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheTEPTHON.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(TheTEPTHON.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheTEPTHON.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(TheTEPTHON.."ttpppi",msg.sender.user_id)
Redis:setex(TheTEPTHON.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(TheTEPTHON.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(TheTEPTHON.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheTEPTHON.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(TheTEPTHON.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TheTEPTHON.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(TheTEPTHON.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('TheTEPTHON:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('TheTEPTHON:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('TheTEPTHON:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('TheTEPTHON:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(TheTEPTHON.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(TheTEPTHON.."transn"..msg.sender.user_id,coniss)
Redis:setex(TheTEPTHON.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(TheTEPTHON.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TheTEPTHON.."noolb"..msg.sender.user_id)
gg = Redis:get(TheTEPTHON.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheTEPTHON.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheTEPTHON.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TheTEPTHON.."transn" .. msg.sender.user_id)
...
if Redis:get(TheTEPTHON.."nonallcc"..text) then
local UserNamey = Redis:get(TheTEPTHON.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(TheTEPTHON.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(TheTEPTHON.."nnonb"..fsvhhh)
nouu = Redis:get(TheTEPTHON.."nnonbn"..fsvhhh)
...
if Redis:get(TheTEPTHON.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(TheTEPTHON.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(TheTEPTHON.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(TheTEPTHON.."polici" .. msg.sender.user_id,600, true)
Redis:setex(TheTEPTHON.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(TheTEPTHON.."nool:flotysb"..bl) or 0
Redis:decrby(TheTEPTHON.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
if Redis:get(TheTEPTHON.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheTEPTHON.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(TheTEPTHON.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 دولار 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(TheTEPTHON.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(TheTEPTHON.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
if Redis:get(TheTEPTHON.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheTEPTHON.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(TheTEPTHON.."ttpppi",msg.sender.user_id)
...
Redis:sadd(TheTEPTHON.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(TheTEPTHON.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheTEPTHON.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(TheTEPTHON.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دولار 💸","md",true)
else
...
if Redis:get(TheTEPTHON.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheTEPTHON.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(TheTEPTHON.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(TheTEPTHON.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(TheTEPTHON.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(TheTEPTHON.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(TheTEPTHON.."ttpppi",msg.sender.user_id)
Redis:setex(TheTEPTHON.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(TheTEPTHON.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(TheTEPTHON.."zrfffidtf",msg.sender.user_id)
Redis:setex(TheTEPTHON.."polic" .. msg.sender.user_id,300, true)
...
Redis:incrby(TheTEPTHON.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(TheTEPTHON.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:setex(TheTEPTHON.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(TheTEPTHON.."noooybgy",msg.sender.user_id) then
if Redis:get(TheTEPTHON.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTEPTHON.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(TheTEPTHON.."mshaher"..msg.chat_id,name)
...
if Redis:get(TheTEPTHON.."TEPTHON:Status:Games"..msg.chat_id) then
Redis:del(TheTEPTHON.."Set:Country"..msg.chat_id)
...
Redis:set(TheTEPTHON.."Game:Countrygof"..msg.chat_id,name)
...
local CmdStart = '*\n‹ : اهلا بك عزيزي في بوت '..(Redis:get(TheTEPTHON.."TEPTHON:Name:Bot") or "تيبثون")..
...
{
{text = '‹ : شࢪوحات السوࢪس -', url = 't.me/tepthon4'},
},
{
{text = '‹ : سۅࢪس -', url = 't.me/Tepthon'},
},
}
}
...
{
{text = '‹ : شࢪوحات السوࢪس', url = 't.me/lZZIlI'}, {text = '‹ : شراء بوت', url = 't.me/P17_12'},
},
{
{text = '‹ : . ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 .', url = 't.me/Tepthon'},
},
...
if tonumber(data.message.sender.user_id) == tonumber(TheTEPTHON) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TheTEPTHON..'TEPTHON:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local Get_Chat = LuaTele.getChat(ChatId)
local GetLink = Redis:get(TheTEPTHON.."TEPTHON:Group:Link"..ChatId) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
...
io.popen("curl -s 'http://185.185.127.158/TEPTHON/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/TEPTHON/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/TEPTHON/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Abs = math.random(2,54); 
local Text ='* . ‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐓𝐞𝐩𝐭𝐡𝐨𝐧 . \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ ‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Tepthon . ❳',url="https://t.me/Tepthon"},{text = ' Updates source ⁦ᯓ',url="https://t.me/Tepthon"}
},
{
{text = ' مبࢪمج السورس',url="https://t.me/P17_12"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ ‹ Tepthon 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/Tepthon"}
},
}
local msg_id = Msg_id/2097152/0.5
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarTEPTHON/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 ‹ Tepthon:',url="t.me/Tepthon"}
},
}
local msg_id = Msg_id/2097152/0.5
...
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(TheTEPTHON.."TEPTHON:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
local TextHelp = [[*
‹ : أهلا بك في قائمة العاب سورس  Tepthonاختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس  Tepthon
...
local bank_users = Redis:smembers(TheTEPTHON.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheTEPTHON.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheTEPTHON..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(TheTEPTHON.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(TheTEPTHON.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(TheTEPTHON.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(TheTEPTHON.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTEPTHON.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
